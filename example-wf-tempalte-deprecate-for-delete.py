...
resource "stackguardian_workflow_template_revision" "example" {
  ...
  source_config_kind = "TERRAFORM"
  is_public          = "1" # Set to 1 to make the revision public

  // Deprecate the revision for deletion
  deprecation = {
    effective_date = "1788450780000"                # Example unix timestamp for deprecation
    message        = "This revision is deprecated." # Deprecation message
  }
