...
func TestToUpdateAPIModel_IsPublic(t *testing.T) {
	...
	base := func(isPublic types.String) WorkflowTemplateResourceModel {
		return WorkflowTemplateResourceModel{
	...
	tests := []struct {
		...
		prior   *WorkflowTemplateResourceModel
		want    *string
	}{
...
func ptr(m WorkflowTemplateResourceModel) *WorkflowTemplateResourceModel { return &m }
