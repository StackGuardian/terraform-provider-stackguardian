	...
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			"user_id": schema.StringAttribute{
				MarkdownDescription: "Fully qualified user email or group. Example: you@exmaple.com for a local user, <SSO Login Method Identifier>/you@exmaple.com for a SSO email when entity_type in EMAIL. <SSO Login Method Identifier>/group-devs when entity_type in GROUP.",
				Required:            true,
			},
