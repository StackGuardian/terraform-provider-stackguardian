...
func resourceStackGuardianConnectorCloudAPI() *schema.Resource {
	...
	return &schema.Resource{
		Create: resourceStackGuardianConnectorCloudAPICreate,
		Read:   resourceStackGuardianConnectorCloudAPIRead,
		Update: resourceStackGuardianConnectorCloudAPIUpdate,
		Delete: resourceStackGuardianConnectorCloudAPIDelete,
		Exists: resourceStackGuardianConnectorCloudAPIExists,

		Importer: &schema.ResourceImporter{
			State: resourceStackGuardianConnectorCloudAPIImport,
		},
...
Since there is nothing in the ResourceData structure other
	...
	from the API
*/
func resourceStackGuardianConnectorCloudAPIImport(d *schema.ResourceData, meta interface{}) (imported []*schema.ResourceData, err error) {
	input := d.Id()
	...
	obj, err := make_api_object_ConnectorCloud(d, meta)
	if err != nil {
		return imported, err
	}
...
func resourceStackGuardianConnectorCloudAPICreate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_ConnectorCloud(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianConnectorCloudAPIRead(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_ConnectorCloud(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianConnectorCloudAPIUpdate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_ConnectorCloud(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianConnectorCloudAPIDelete(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_ConnectorCloud(d, meta)
	if err != nil {
		return err
	}
	...
	log.Printf("warning: deletion of ConnectorCloud resource is not possible with API Key")
...
func resourceStackGuardianConnectorCloudAPIExists(d *schema.ResourceData, meta interface{}) (exists bool, err error) {
	obj, err := make_api_object_ConnectorCloud(d, meta)
	if err != nil {
		return exists, err
	}
...
*/
func make_api_object_ConnectorCloud(d *schema.ResourceData, meta interface{}) (*api_object, error) {
	opts, err := buildApiObjectConnectorCloudOpts(d)
	if err != nil {
		return nil, err
	}
