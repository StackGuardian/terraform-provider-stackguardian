...
func resourceStackGuardianRoleAPI() *schema.Resource {
	...
	return &schema.Resource{
		Create: resourceStackGuardianRoleAPICreate,
		Read:   resourceStackGuardianRoleAPIRead,
		Update: resourceStackGuardianRoleAPIUpdate,
		Delete: resourceStackGuardianRoleAPIDelete,
		Exists: resourceStackGuardianRoleAPIExists,

		Importer: &schema.ResourceImporter{
			State: resourceStackGuardianRoleAPIImport,
		},

		Schema: map[string]*schema.Schema{
			"data": {
				Type:        schema.TypeString,
				Description: "Valid JSON data that this provider will manage with the API server. Please refer to the API Docs: https://docs.stackguardian.io/api#tag/Role",
				Required:    true,
...
Since there is nothing in the ResourceData structure other
	...
	from the API
*/
func resourceStackGuardianRoleAPIImport(d *schema.ResourceData, meta interface{}) (imported []*schema.ResourceData, err error) {
	input := d.Id()
	...
	obj, err := make_api_object_Role(d, meta)
	if err != nil {
		return imported, err
	}
...
func resourceStackGuardianRoleAPICreate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_Role(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianRoleAPIRead(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_Role(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianRoleAPIUpdate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_Role(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianRoleAPIDelete(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_Role(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianRoleAPIExists(d *schema.ResourceData, meta interface{}) (exists bool, err error) {
	obj, err := make_api_object_Role(d, meta)
	if err != nil {
		return exists, err
	}
...
*/
func make_api_object_Role(d *schema.ResourceData, meta interface{}) (*api_object, error) {
	opts, err := buildApiObjectOpts_Role(d)
	if err != nil {
		return nil, err
	}
...
func buildApiObjectOpts_Role(d *schema.ResourceData) (*apiObjectOpts, error) {
	resultPath := "/roles/"
