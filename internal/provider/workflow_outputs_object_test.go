...
data "stackguardian_workflow_outputs" "TPS-Test-Outputs" {
  ...
  output "website_url_from_mapstr" {
	value = data.stackguardian_workflow_outputs.TPS-Test-Outputs.outputs_str.sample_website_url
  }


  output "website_url_from_json" {
	value = jsondecode(data.stackguardian_workflow_outputs.TPS-Test-Outputs.outputs_json).sample_website_url.value
  }

  output "outputs_full_json" {
	value = jsondecode(data.stackguardian_workflow_outputs.TPS-Test-Outputs.outputs_json)
  }
`
