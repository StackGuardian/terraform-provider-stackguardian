...
func resourceStackGuardianPolicyAPI() *schema.Resource {
	...
	return &schema.Resource{
		Create: resourceresourceStackGuardianPolicyAPICreate,
		Read:   resourceresourceStackGuardianPolicyAPIRead,
		Update: resourceresourceStackGuardianPolicyAPIUpdate,
		Delete: resourceresourceStackGuardianPolicyAPIDelete,
		Exists: resourceresourceStackGuardianPolicyAPIExists,

		Importer: &schema.ResourceImporter{
			State: resourceresourceStackGuardianPolicyAPIImport,
		},
...
Since there is nothing in the ResourceData structure other
	...
	from the API
*/
func resourceresourceStackGuardianPolicyAPIImport(d *schema.ResourceData, meta interface{}) (imported []*schema.ResourceData, err error) {
	input := d.Id()
...
func resourceresourceStackGuardianPolicyAPICreate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianPolicyAPIRead(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianPolicyAPIUpdate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianPolicyAPIDelete(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianPolicyAPIExists(d *schema.ResourceData, meta interface{}) (exists bool, err error) {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return exists, err
	}
