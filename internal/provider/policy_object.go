...
func resourceStackGuardianPolicyAPI() *schema.Resource {
	...
	return &schema.Resource{
		Create: resourceStackGuardianPolicyAPICreate,
		Read:   resourceStackGuardianPolicyAPIRead,
		Update: resourceStackGuardianPolicyAPIUpdate,
		Delete: resourceStackGuardianPolicyAPIDelete,
		Exists: resourceStackGuardianPolicyAPIExists,

		Importer: &schema.ResourceImporter{
			State: resourceStackGuardianPolicyAPIImport,
		},

		Schema: map[string]*schema.Schema{
			"data": {
				Type:        schema.TypeString,
				Description: "Valid JSON data that this provider will manage with the API server. Please refer to the API Docs: https://docs.stackguardian.io/api#tag/Policies",
				Required:    true,
...
Since there is nothing in the ResourceData structure other
	...
	from the API
*/
func resourceStackGuardianPolicyAPIImport(d *schema.ResourceData, meta interface{}) (imported []*schema.ResourceData, err error) {
	input := d.Id()
	...
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return imported, err
	}
...
func resourceStackGuardianPolicyAPICreate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianPolicyAPIRead(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianPolicyAPIUpdate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianPolicyAPIDelete(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return err
	}
...
func resourceStackGuardianPolicyAPIExists(d *schema.ResourceData, meta interface{}) (exists bool, err error) {
	obj, err := make_api_object_policy(d, meta)
	if err != nil {
		return exists, err
	}
...
*/
func make_api_object_policy(d *schema.ResourceData, meta interface{}) (*api_object, error) {
	opts, err := buildApiObjectPolicyOpts(d)
	if err != nil {
		return nil, err
	}
...
func buildApiObjectPolicyOpts(d *schema.ResourceData) (*apiObjectOpts, error) {
	resultPath := "/policies/"
