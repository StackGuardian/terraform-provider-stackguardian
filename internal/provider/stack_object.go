...
func resourceStackGuardianStackAPI() *schema.Resource {
	...
	return &schema.Resource{
		Create: resourceresourceStackGuardianStackAPICreate,
		Read:   resourceresourceStackGuardianStackAPIRead,
		Update: resourceresourceStackGuardianStackAPIUpdate,
		Delete: resourceresourceStackGuardianStackAPIDelete,
		Exists: resourceresourceStackGuardianStackAPIExists,

		Importer: &schema.ResourceImporter{
			State: resourceresourceStackGuardianStackAPIImport,
		},
...
Since there is nothing in the ResourceData structure other
	...
	from the API
*/
func resourceresourceStackGuardianStackAPIImport(d *schema.ResourceData, meta interface{}) (imported []*schema.ResourceData, err error) {
	input := d.Id()
...
func resourceresourceStackGuardianStackAPICreate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_stack(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianStackAPIRead(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_stack(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianStackAPIUpdate(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_stack(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianStackAPIDelete(d *schema.ResourceData, meta interface{}) error {
	obj, err := make_api_object_stack(d, meta)
	if err != nil {
		return err
	}
...
func resourceresourceStackGuardianStackAPIExists(d *schema.ResourceData, meta interface{}) (exists bool, err error) {
	obj, err := make_api_object_stack(d, meta)
	if err != nil {
		return exists, err
	}
