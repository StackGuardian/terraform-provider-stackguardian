...
var wfStepInputDataSchema = schema.SingleNestedAttribute{
	Computed: true,
	Attributes: map[string]schema.Attribute{
...
var wfStepsConfigSchema = schema.NestedAttributeObject{
	Attributes: map[string]schema.Attribute{
		...
		"wf_step_input_data":    wfStepInputDataSchema,
	},
}
...
var terraformConfigSchema = schema.SingleNestedAttribute{
	...
	Attributes: map[string]schema.Attribute{
		...
		"terraform_bin_path":          mountPointsSchema,
		"timeout":                     schema.Int64Attribute{Computed: true},
...
var vcsConfigSchema = schema.SingleNestedAttribute{
	Computed: true,
	Attributes: map[string]schema.Attribute{
		"iac_vcs_config": schema.SingleNestedAttribute{
			Computed: true,
			Attributes: map[string]schema.Attribute{
				"use_marketplace_template": schema.BoolAttribute{Computed: true},
				"iac_template_id":          schema.StringAttribute{Computed: true},
				"custom_source": schema.SingleNestedAttribute{
					Computed: true,
					Attributes: map[string]schema.Attribute{
						"source_config_dest_kind": schema.StringAttribute{Computed: true},
						"config": schema.SingleNestedAttribute{
							Computed: true,
							Attributes: map[string]schema.Attribute{
								"is_private":                 schema.BoolAttribute{Computed: true},
								"auth":                       schema.StringAttribute{Computed: true, Sensitive: true},
								"working_dir":                schema.StringAttribute{Computed: true},
								"git_sparse_checkout_config": schema.StringAttribute{Computed: true},
								"git_core_auto_crlf":         schema.BoolAttribute{Computed: true},
								"ref":                        schema.StringAttribute{Computed: true},
								"repo":                       schema.StringAttribute{Computed: true},
								"include_sub_module":         schema.BoolAttribute{Computed: true},
							},
						},
					},
				},
...
func (d *workflowDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Use this data source to read a workflow.",
		Attributes: map[string]schema.Attribute{
