...
const (
	...
	EnvVarConfigSecretId  = `ID of the secret (if using vault secret). Use if type is <span style="background-color: #eff0f0; color: #e53835;">SECRET_REF</span>`
	EnvVarConfigTextValue = `Text value (if using plain text). Use if type is <span style="background-color: #eff0f0; color: #e53835;">TEXT</span>`
...
const (
	...
	MiniStepsWfChainingStackPayload = "Overrides for the stack to be triggered"
	MiniStepsWfChainingWorkflowId   = "Workflow id for the workflow to be triggered"
	MiniStepsWfChainingWorkflowPayload = "Overrides for the workflow to be triggered"
)
...
const (
	...
	MountPointReadOnly = "If the directory is read only or not"
)
...
const (
	...
	WfStepCmdOverride       = "Override command for the step (JSON)."
	WfStepMountPoints       = "Mount points for the step."
	WfStepTemplateId        = "Workflow step template ID."
	WfStepInputData         = "Workflow step input data."
	WfStepInputDataSchemaType = "Schema type."
